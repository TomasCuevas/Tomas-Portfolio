    ...
    >
      <div className="flex h-14 w-full max-w-[1000px] items-center justify-between rounded-full bg-darkLight/90 px-4 backdrop-blur-sm md:h-[66px] md:px-8">
        ...
        <ul className="hidden h-full items-center gap-5 md:flex lg:gap-7">
          <li>
            <button onClick={() => navigate("hero")}>
              <span className="text-xl font-light tracking-[1px] text-light/60 transition-all duration-300 hover:text-light">
                Inicio
              </span>
            </button>
          </li>
        ...
        <button
          ...
          className="hidden items-center rounded-md border border-light/60 text-light/60 transition-all duration-300 hover:border-light hover:text-light md:flex"
        >
